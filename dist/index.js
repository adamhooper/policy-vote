...
module.exports = DoneView = (function(superClass) {
  extend(DoneView, superClass);

  function DoneView() {
    return DoneView.__super__.constructor.apply(this, arguments);
  }
...
module.exports = HeadingView = (function(superClass) {
  extend(HeadingView, superClass);

  function HeadingView() {
    return HeadingView.__super__.constructor.apply(this, arguments);
  }

  HeadingView.prototype.tagName = 'header';

  HeadingView.prototype.template = _.template('<h1>Pick the idea you prefer:</h1>');
...
module.exports = QuestionView = (function(superClass) {
  ...
  QuestionView.prototype.render = function() {
    var policy1, policy2, ref;
    ref = this.pick2(), policy1 = ref[0], policy2 = ref[1];
    return this.$el.html(this.template({
      policy1: policy1,
      policy2: policy2
    }));
  ...
  QuestionView.prototype._onClickButton = function(e) {
